...
class Real_Input():
    ...
    def Read_assign_locations(self):
        ...
        self.G.node[0]['location']=( self.loc_data[0,0] , self.loc_data[0,1] )
        self.G.node[self.NN+1]['location']=( self.loc_data[0,0] , self.loc_data[0,1] )
        self.G.node[0]['AngleWithDepot']=0
        self.G.node[self.NN+1]['AngleWithDepot']=0
        
        for i in range(1,self.NN):
            self.G.node[i]['location']=( self.loc_data[i,0] , self.loc_data[i,1] )
